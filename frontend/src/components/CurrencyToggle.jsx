    ...
    <div className={`flex items-center gap-1.5 ${className}`}>
      ...
      <div className="relative flex items-center">
        <select
          ...
          className="input-base text-xs font-bold py-1.5 pl-2.5 pr-8 min-h-[44px] bg-surface-800 border-surface-700/60 text-white rounded-lg focus:outline-none focus:ring-1 focus:ring-brand-400 cursor-pointer appearance-none"
